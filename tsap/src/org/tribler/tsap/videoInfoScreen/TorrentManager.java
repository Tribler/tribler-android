...
public class TorrentManager {
	...
	public static void initiliazeTorrents()
	{
		...
		torrents.add(new Torrent("Dracula","Video",new Date(2008,10,8),500,56,6,"Dracula",R.drawable.dracula));
		torrents.add(new Torrent("King Kong","Video",new Date(2007,7,8),600.59,66,2,"King Kong",R.drawable.kingkong));
	}
