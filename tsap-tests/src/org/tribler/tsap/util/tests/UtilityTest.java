...
public class UtilityTest extends AndroidTestCase {
	...
	public void testDownloadStateConversionValid() {
		...
		assertEquals("state converted incorrectly",
	...
	public void testGetFromMapString() {
		assertTrue(Utility.getFromMap(testMap, "stringtest", "fail").equals(
				"hello"));
		assertTrue(Utility.getFromMap(testMap, "invalid_string", "fail")
				.equals("fail"));
	}
