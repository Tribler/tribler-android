...
public class ThumbItem {
	 ...
	 * @param thumbnailId The thumbnail belonging to the torrent
	 * @param health The health of the torrent
	 ...
	 * @param thumbnailId The id of the new thumbnail resource
	 */
	 ...
	 * @param size The new size of the torrent
	 */
	 ...
	 * @param health The new health of the torrent
	 */
