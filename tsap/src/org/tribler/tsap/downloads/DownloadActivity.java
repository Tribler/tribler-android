...
public class DownloadActivity extends Activity {
	...
	private void fillLayout() {
		...
		download.setText(Util.convertBytesPerSecToString(mDownload.getDownloadSpeed()));

		TextView upload = (TextView) mView
				.findViewById(R.id.download_info_up_speed);
		upload.setText(Util.convertBytesPerSecToString(mDownload.getUploadSpeed()));
