...
public class MainActivityTest extends ActivityInstrumentationTestCase2<MainActivity> {
	...
	public void testContainerExists()
	{
		...
		assertEquals("Container isn't a FrameLayout",FrameLayout.class, container.getClass());
	}
	...
	{
		final CharSequence expected = mMainActivity.getString(R.string.app_name);
	...
	public void testActionBar()
	{
		...
		assertEquals("Navigation mode of action bar incorrect",ActionBar.NAVIGATION_MODE_STANDARD, actionBar.getNavigationMode());
		assertEquals("ActionBar title is incorrect",mMainActivity.getString(R.string.app_name),actionBar.getTitle());
	}
}
