...
public class TorrentTest extends TestCase {
	...
	{
		super.setUp();
		mTorrent = new Torrent("Sintel 2010", "Video", "2011-08-07", 426.89, 54,4,"Sintel is a...",R.drawable.sintel);
	}
	...
	public void testGetters()
	{
		...
		assertEquals("getUploadDate() incorrect", "2011-08-07", mTorrent.getUploadDate());
		assertEquals("getFileSize() incorrect", "426.89 MB", mTorrent.getFilesize());
		assertEquals("getSeeders() incorrect", "54", mTorrent.getSeeders());
		assertEquals("getLeechers() incorrect", "4", mTorrent.getLeechers());
		assertEquals("getDescription() incorrect", "Sintel is a...", mTorrent.getDescription());
		assertEquals("getThumbnailID() incorrect", R.drawable.sintel, mTorrent.getThumbnailID());
	}
