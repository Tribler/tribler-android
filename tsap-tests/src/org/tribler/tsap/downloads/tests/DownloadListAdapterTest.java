...
public class DownloadListAdapterTest extends ActivityInstrumentationTestCase2<MainActivity> {
	...
	Download a = new Download("a", "hash1", 1, 1234.5, 5.4321, 0.2, 0.1, 0.1, false);
	Download b = new Download("b", "hash2", 2, 123.45, 54.321, 0.3, 0.1, 0.1, false);
	Download c = new Download("c", "hash3", 3, 12.345, 543.21, 0.4, 0.1, 0.1, false);
	Download d = new Download("d", "hash4", 4, 1.2345, 5432.1, 0.5, 0.1, 0.1, false);
	...
	public void testGetView() {
		...
		checkView(adapter.getView(1, null, null), "b", "Status: Waiting for hash check (30%)", "Down: 123 B/s", "Up: 54 B/s", 30);
		checkView(adapter.getView(2, null, null), "c", "Status: Downloading (40%)", "Down: 12 B/s", "Up: 543 B/s", 40);
